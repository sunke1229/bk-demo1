...
<link href="//magicbox.bk.tencent.com/static_api/v3/assets/bk-icon-2.0/iconfont.css" rel="stylesheet">
<link href="//magicbox.bk.tencent.com/static_api/v3/bk/css/components/button.css" rel="stylesheet">
<link href="//magicbox.bk.tencent.com/static_api/v3/assets/metisMenu-2.6.0/css/metisMenu.min.css" rel="stylesheet">
<link href="//magicbox.bk.tencent.com/static_api/v3/bk/css/base/common.css" rel="stylesheet">
                    ...
                    <div class="king-block king-block-bordered king-block-themed m5">
                        <div class="king-block-content">
                            <div class="form-group clearfix ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bk-valign-top"
                            ...
                            <div class="form-group clearfix ">
                                ...
                                <div class="col-sm-9">
                                    <button id = "chooseHost" type="button" class="bk-button bk-primary" title="选择服务器">
                                        <i class="bk-icon icon-pc"></i><span>选择服务器</span>
                                    </button>
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-9">
                                    <label class="radio-inline"> <input  checked type="radio" value="2" name="scriptFrom">公共脚本</label>
                                </div>
                            </div>
                            ...
                            <div  class="form-group" id="commonScript">
                            ...
                            <div class="form-group has-feedback clearfix ">
                                ...
                                <div class="col-sm-9" style="border: 0px solid #ddd;" id="editor2_demo1">
                                    ...
                                    <textarea id="editor2_demo">asdad</textarea>
                                    <!-- 代码文本 start -->
                                    <pre id="code_box" style="display:none;">asdasdsad</pre>
                                    <!-- 代码文本 end -->
                            ...
                            <div class="form-group clearfix ">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control bk-valign-top"  placeholder="提示信息">
                                </div>
                            </div>
                            <div class="form-group clearfix">
    ...
    function loadTable(){
        ...
        $("#example").DataTable({
            ...
            rowCallback: function( row, data ) {
                ...
                console.log(String(data.DT_RowId));
        ...
        $('#example tbody ').on('click', 'tr', function () {
            var id = this.id;
            var ip= $(this).find("td").eq(1).html();
            var bkCloudId = $(this).find("td").eq(4).html();

            if ( !selected.get(id)) {
                selected.set(id,{ip:ip,bkCloudId:bkCloudId});
            } else {
                selected.delete( id );
            }
